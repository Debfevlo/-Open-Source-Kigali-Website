export { PROJECTS, GOOD_FIRST_ISSUES } from "./projects";
...
export { COMMUNITY_STATS, CHANNELS, GUIDELINES, SOCIAL_PLATFORMS} from "./community";
export { RESOURCES, EXTERNAL_TOOLS, LEARNING_PATHS,} from "./resources";
